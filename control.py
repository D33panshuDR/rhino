...
class Controller:
    ...
    def wait_for_heartbeat(self):
        ...
        try:
            ...
            raise IOError(f"No heartbeat received from vehicle. Check connection. Details: {e}")
    ...
    def send_rc_override(self, throttle_pwm: int, steering_pwm: int, throttle_channel: int, steering_channel: int):
        """
